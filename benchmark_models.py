...
def train(type="single"):
    ...
    for model_type in MODEL_LIST.keys():
        for model_name in MODEL_LIST[model_type]:
            ...
            durations = []
            print(
                "Benchmarking Training {} precision type {} ".format(type, model_name)
            )
    ...
    with torch.no_grad():
        for model_type in MODEL_LIST.keys():
            for model_name in MODEL_LIST[model_type]:
                ...
                durations = []
                print(
                    "Benchmarking Inference {} precision type {} ".format(
                        type, model_name
                    )
                )
                for step, img in enumerate(rand_loader):
    ...
    for precision in precisions:
        ...
        path = "".join(
            (
                ...
                "_",
                precision,
                "_model_inference_benchmark.csv",
            )
        )
